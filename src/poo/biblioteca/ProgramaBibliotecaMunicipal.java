...
public class ProgramaBibliotecaMunicipal {
    ...
    public static void main(String[] args) {
        Biblioteca biblioLeganes = new Biblioteca("Biblioteca Pío Baroja", "Avda Mediterráneo");

        cargarLibrosReales(biblioLeganes);

        biblioLeganes.mostrarCatalogo();

        System.out.println("Dime nº de páginas máximo y te busco los libros menores de ese limite");
        Scanner teclado = new Scanner(System.in);
        int numeroMax = teclado.nextInt();
        teclado.nextLine();

        biblioLeganes.mostrarLibrosPorMaxPaginas(numeroMax);
