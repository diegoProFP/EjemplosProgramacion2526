...
public class EjemploSet {
    ...
    En el constructor de CancionReal, que reciba el Autor

    Crear un conjunto de objetos de CancionReal, que no permita tener
    duplicados de CancionReal, considerando que 2 canciones reales
    son iguales si su nombre y su autor son iguales. 2 autores
    son iguales si sus nombres son iguales
     */
